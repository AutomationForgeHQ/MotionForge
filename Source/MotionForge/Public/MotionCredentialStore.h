 ...
 * and let it go.
 */
class MOTIONFORGE_API FMotionCredentialStore
{
public:

	/**
	 * Fetch a secret for a service, e.g. "Uthana".
	 *
	...
	/** The environment variable consulted for a service, e.g. MOTIONFORGE_UTHANA_KEY. */
